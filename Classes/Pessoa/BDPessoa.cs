    ...
    class BDPessoa
    {
        ...
        public int Incluir(Pessoa pobj_Pessoa)
        {
            ...
            string s_SQL_Comando = "INSERT INTO tb_pessoa " +
                                   ...
                                   "@I_NVL_PESSOA " +
                                   "); " +
                                   " SELECT MAX(I_COD_PESSOA) AS 'ID' FROM tb_pessoa ";
            ...
            obj_Cmd.Parameters.AddWithValue("@I_NVL_PESSOA", pobj_Pessoa.Nvl_Pessoa);
            obj_Cmd.Parameters.AddWithValue("@S_SEN_PESSOA", pobj_Pessoa.Sen_Pessoa);
        ...
        ***********************************************************************/
        public bool Alterar(Pessoa pobj_Pessoa)
        {
            ...
            string s_SQL_Comando = "UPDATE TB_PESSOA SET " +
                                   ...
                                   "I_NVL_PESSOA = @I_NVL_PESSOA, " +
                                   "S_SEN_PESSOA = @S_SEN_PESSOA, " +
                                   "B_DEL_PESSOA = 0 " +
                                   "WHERE I_COD_PESSOA = @I_COD_PESSOA AND B_DEL_PESSOA = 0;";
            ...
            obj_Cmd.Parameters.AddWithValue("@S_CEL_PESSOA", pobj_Pessoa.Cel_Pessoa);
            obj_Cmd.Parameters.AddWithValue("@S_MAIL_PESSOA", pobj_Pessoa.Mail_Pessoa);
            obj_Cmd.Parameters.AddWithValue("@S_NVL_PESSOA", pobj_Pessoa.Nvl_Pessoa);
            obj_Cmd.Parameters.AddWithValue("@S_SEN_PESSOA", pobj_Pessoa.Sen_Pessoa);
        ...
        ***********************************************************************/
        ...
        {
            MySqlConnection obj_Con = new MySqlConnection(Connection.ConnectionPath());
            string s_SQL_Comando = "DELETE FROM TB_PESSOA " +
            ...
            try
            {
                ...
                if (obj_Dtr.HasRows)
                {
                    ...
                    while (obj_Dtr.Read())
                    {
                        ...
                        obj_Pessoa.Sen_Pessoa = obj_Dtr["S_Sen_PESSOA"].ToString();
                        obj_Pessoa.Del_Pessoa = (Convert.ToInt16(obj_Dtr["B_DEL_PESSOA"]) == 1) ? true : false;
                        obj_Pessoa.Nvl_Pessoa = Convert.ToInt16(obj_Dtr["I_NVL_PESSOA"]);
        ...
        public Pessoa FindByCodPessoa(Pessoa pobj_Pessoa)
        {
            ...
            try
            {
                ...
                if (obj_Dtr.HasRows)
                {
                    ...
                    pobj_Pessoa.Sen_Pessoa = obj_Dtr["S_Sen_PESSOA"].ToString();
                    pobj_Pessoa.Del_Pessoa = (Convert.ToInt16(obj_Dtr["B_DEL_PESSOA"]) == 1) ? true : false;
                    pobj_Pessoa.Nvl_Pessoa = Convert.ToInt16(obj_Dtr["I_NVL_PESSOA"]);
                    obj_Con.Close();
                    obj_Dtr.Close();
                    return pobj_Pessoa;
                }
