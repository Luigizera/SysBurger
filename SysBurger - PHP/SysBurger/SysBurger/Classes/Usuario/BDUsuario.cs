    ...
    class BDUsuario
    {
        ...
        public int Incluir(Usuario pobj_Usuario)
        {
            ...
            string s_SQL_Comando = "INSERT INTO TB_USUARIO " +
                                   ...
                                   "@S_NVL_USUARIO " +
                                   "); " +
                                   " SELECT MAX(I_COD_USUARIO) AS 'ID' FROM TB_USUARIO ";
            ...
            obj_Cmd.Parameters.AddWithValue("@I_NVL_USUARIO", pobj_Usuario.Nvl_Usuario);
        ...
        ***********************************************************************/
        public bool Alterar(Usuario pobj_Usuario)
        {
            ...
            string s_SQL_Comando = "UPDATE TB_USUARIO SET " +
                                   ...
                                   "I_NVL_USUARIO = @I_NVL_USUARIO" +
                                   "WHERE I_COD_USUARIO = @I_COD_USUARIO AND B_DEL_USUARIO = 0;";
        ...
        ***********************************************************************/
        ...
        {
            MySqlConnection obj_Con = new MySqlConnection(Connection.ConnectionPath());
            string s_SQL_Comando = "DELETE FROM TB_USUARIO " +
        ...
        public Usuario FindByUnmUsuario(Usuario pobj_Usuario)
        {
            ...
            try
            {
                ...
                if (obj_Dtr.HasRows)
                {
                    ...
                    pobj_Usuario.Nvl_Usuario = Convert.ToInt16(obj_Dtr["I_NVL_USUARIO"]);
            ...
            try
            {
                ...
                if (obj_Dtr.HasRows)
                {
                    ...
                    while (obj_Dtr.Read())
                    {
                        ...
                        obj_Usuario.Nvl_Usuario = Convert.ToInt16(obj_Dtr["I_NVL_USUARIO"]);
