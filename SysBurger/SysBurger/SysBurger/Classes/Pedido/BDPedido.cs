    ...
    class BDPedido
    {
        ...
        public int Incluir(Pedido pobj_Pedido)
        {
            ...
            string s_SQL_Comando = "INSERT INTO TB_PEDIDO " +
                                   ...
                                   "@S_PED_PEDIDO, " +
                                   "@I_QNT_PEDIDO, " +
                                   "REPLACE(@D_VLRQNT_PEDIDO, ',', '.'), " +
                                   "REPLACE(@D_VLRTOT_PEDIDO, ',', '.'), " +
                                   "@DT_COMP_PEDIDO, " +
                                   "@B_DEL_PEDIDO " +
                                   "); " +
            ...
            obj_Cmd.Parameters.AddWithValue("@B_DEL_PEDIDO", pobj_Pedido.Del_Pedido);
        ...
        ***********************************************************************/
        public bool Alterar(Pedido pobj_Pedido)
        {
            ...
            string s_SQL_Comando = "UPDATE TB_PEDIDO SET " +
                                   ...
                                   "D_VLRQNT_PEDIDO = REPLACE(@D_VLRQNT_PEDIDO, ',', '.'), " +
                                   "D_VLRTOT_PEDIDO = REPLACE(@D_VLRTOT_PEDIDO, ',', '.'), " +
                                   "DT_COMP_PEDIDO = @DT_COMP_PEDIDO, " +
                                   "B_DEL_PEDIDO = @B_DEL_PEDIDO " +
        ...
        ***********************************************************************/
        ...
        {
            SqlConnection obj_Con = new SqlConnection(Connection.ConnectionPath());
            string s_SQL_Comando = "UPDATE TB_PEDIDO " +
                                   "SET B_DEL_PEDIDO = 1 " +
                                   "WHERE S_PED_PEDIDO = @S_PED_PEDIDO;";
            SqlCommand obj_Cmd = new SqlCommand(s_SQL_Comando, obj_Con);
            obj_Cmd.Parameters.AddWithValue("@S_PED_PEDIDO", pobj_Pedido.Ped_Pedido);
