    ...
    class BDEndereco
    {
        ...
        public int Incluir(Endereco pobj_Endereco)
        {
            ...
            string s_SQL_Comando = "INSERT INTO TB_ENDERECO " +
                                   ...
                                   "@S_CEP_ENDERECO " +
                                   "); " +
                                   " SELECT IDENT_CURRENT('TB_ENDERECO') AS 'ID' ";
        ...
        *        Método: Excluir
        *     Parametro: Objeto Endereco
        *          Obs.: Responsável por Excluir um registro na tabela Endereco.
        *   Dt. Criação: 06/07/2022
        * Dt. Alteração: --
        *    Criada por: LuigiGM 
        ***********************************************************************/
        public bool Excluir(Endereco pobj_Endereco)
        {
            SqlConnection obj_Con = new SqlConnection(Connection.ConnectionPath());
            string s_SQL_Comando = "DELETE FROM TB_ENDERECO " +
                                   "WHERE I_COD_ENDERECO = @I_COD_ENDERECO;";
            SqlCommand obj_Cmd = new SqlCommand(s_SQL_Comando, obj_Con);
            obj_Cmd.Parameters.AddWithValue("@I_COD_ENDERECO", pobj_Endereco.Cod_Endereco);
            try
