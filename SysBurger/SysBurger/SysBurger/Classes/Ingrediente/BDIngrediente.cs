    ...
    class BDIngrediente
    {
        ...
        public int Incluir(Ingrediente pobj_Ingrediente)
        {
            ...
            string s_SQL_Comando = "INSERT INTO TB_INGREDIENTE " +
                                   ...
                                   "@B_DEL_INGREDIENTE " +
                                   "); " +
                                   " SELECT IDENT_CURRENT('TB_INGREDIENTE') AS 'ID' ";
        ...
        ***********************************************************************/
        public bool Alterar(Ingrediente pobj_Ingrediente)
        {
            ...
            string s_SQL_Comando = "UPDATE TB_INGREDIENTE SET " +
                                   ...
                                   "B_DEL_INGREDIENTE  = @B_DEL_INGREDIENTE " +
        ...
        *        Método: Excluir
        *     Parametro: Objeto Ingrediente
        *          Obs.: Responsável por Excluir um registro na tabela Ingrediente.
        *   Dt. Criação: 06/07/2022
        * Dt. Alteração: --
        *    Criada por: LuigiGM 
        ***********************************************************************/
        public bool Excluir(Ingrediente pobj_Ingrediente)
        {
            SqlConnection obj_Con = new SqlConnection(Connection.ConnectionPath());
            string s_SQL_Comando = "UPDATE TB_INGREDIENTE " +
                                   "SET B_DEL_INGREDIENTE = 1 " +
                                   "WHERE I_COD_INGREDIENTE = @I_COD_INGREDIENTE;";
            SqlCommand obj_Cmd = new SqlCommand(s_SQL_Comando, obj_Con);
            obj_Cmd.Parameters.AddWithValue("@I_COD_INGREDIENTE", pobj_Ingrediente.Cod_Ingrediente);
            try
