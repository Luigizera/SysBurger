...
namespace SysBurger
{
    public partial class frm_Endereco : Form
    {
        ...
        private void btn_Novo_Click(object sender, EventArgs e)
        {
            ...
            mtbox_Cod_Pessoa.Text = i_Cod_Pessoa.ToString();
        ...
        ***********************************************************************/
        private Endereco PopulaObjeto()
        {
            ...
            obj_Endereco.Cod_Pessoa = Convert.ToInt16(mtbox_Cod_Pessoa.Text);
        ...
        ***********************************************************************/
        private void PopulaTela(Endereco pobj_Endereco)
        {
            ...
            mtbox_Cod_Pessoa.Text = pobj_Endereco.Cod_Pessoa.ToString();
        ...
        ***********************************************************************/
        ...
        private void mtbox_Cod_Pessoa_Leave(object sender, EventArgs e)
        {
            if (mtbox_Cod_Pessoa.Text != "")
            {
                ...
                obj_Pessoa.Cod_Pessoa = Convert.ToInt16(((MaskedTextBox)sender).Text);
