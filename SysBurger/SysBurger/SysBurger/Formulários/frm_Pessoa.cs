    ...
    public partial class frm_Pessoa : Form
    {
        ...
        ***********************************************************************/
        private void PopulaTela(Pessoa pobj_Pessoa)
        {
            ...
            if (Lista != null)
            {
                mtbox_Cod_Endereco.Text = Lista[0].Cod_Endereco.ToString();
                mtbox_Cod_Endereco_Leave(mtbox_Cod_Endereco, e);
            }
            else
            {
        ...
        ***********************************************************************/
        ...
        private void btn_Endereco_Click(object sender, EventArgs e)
        {
            ...
            mtbox_Cod_Endereco.Text = obj_frm_Endereco.obj_Endereco_Atual.Cod_Endereco.ToString();
