    ...
    public partial class frm_Ingrediente_Produto : Form
    {
        ...
        ***********************************************************************/
        private void PopulaObjeto(Ingrediente_Produto pobj_Ingrediente_Produto, Produto pobj_Produto, Ingrediente pobj_Ingrediente)
        {
            ...
            pobj_Ingrediente_Produto.Cod_Produto = Convert.ToInt16(mtbox_Cod_Produto.Text);
            pobj_Ingrediente_Produto.Cod_Ingrediente = Convert.ToInt16(mtbox_Cod_Ingrediente.Text);
            pobj_Ingrediente_Produto.QntUt_Ingrediente_Produto = Convert.ToInt16(mtbox_QntUt_Ingrediente_Produto.Text);
        ...
        ***********************************************************************/
        private void PopulaTela(Ingrediente_Produto pobj_Ingrediente_Produto, Produto pobj_Produto, Ingrediente pobj_Ingrediente)
        {
            ...
            mtbox_Cod_Produto.Text = pobj_Ingrediente_Produto.Cod_Produto.ToString();
            mtbox_Cod_Ingrediente.Text = pobj_Ingrediente_Produto.Cod_Ingrediente.ToString();
            mtbox_QntUt_Ingrediente_Produto.Text = pobj_Ingrediente_Produto.QntUt_Ingrediente_Produto.ToString();

            EventArgs e = new EventArgs();
            mtbox_Cod_Produto_Leave(mtbox_Cod_Produto, e);
            mtbox_Cod_Ingrediente_Leave(mtbox_Cod_Ingrediente, e);
        }
        ...
        ***********************************************************************/
        ...
        private void btn_Produto_Click(object sender, EventArgs e)
        {
            ...
            mtbox_Cod_Produto.Text = obj_frm_Produto.obj_Produto_Atual.Cod_Produto.ToString();
            mtbox_Cod_Produto_Leave(mtbox_Cod_Produto, e);
        }
        ...
        private void btn_Ingrediente_Click(object sender, EventArgs e)
        {
            ...
            mtbox_Cod_Ingrediente.Text = obj_frm_Ingrediente.obj_Ingrediente_Atual.Cod_Ingrediente.ToString();
            mtbox_Cod_Ingrediente_Leave(mtbox_Cod_Ingrediente, e);
        }

        private void mtbox_Cod_Ingrediente_Leave(object sender, EventArgs e)
        {
            obj_Ingrediente_Atual = new Ingrediente();

            if (mtbox_Cod_Ingrediente.Text != "")
            {
                BDIngrediente obj_BDIngrediente = new BDIngrediente();
                obj_Ingrediente_Atual.Cod_Ingrediente = Convert.ToInt16(((MaskedTextBox)sender).Text);
                ...
                {
                    mtbox_Cod_Ingrediente.Text = null;
                    lb_Nm_Ingrediente.Text = "";
                }
            }
        }

        private void mtbox_Cod_Produto_KeyPress(object sender, KeyPressEventArgs e)
        {
            obj_FuncGeral.DigitaNumero(this,sender, e);
        }

        private void mtbox_Cod_Ingrediente_KeyPress(object sender, KeyPressEventArgs e)
        {
            obj_FuncGeral.DigitaNumero(this, sender, e);
        }

        private void mtbox_QntUt_Ingrediente_Produto_KeyPress(object sender, KeyPressEventArgs e)
        {
            obj_FuncGeral.DigitaNumero(this, sender, e);
        }
    }
