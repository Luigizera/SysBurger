    ...
    public partial class frm_Usuario : Form
    {
        ...
        ***********************************************************************/
        private Usuario PopulaObjeto()
        {
            ...
            Usuario obj_Usuario_Senha = new Usuario();
            ...
            if (tbox_Sen_Usuario.Text == "" && obj_Usuario.Cod_Usuario != -1)
            {
                BDUsuario obj_BDUsuario = new BDUsuario();
                obj_BDUsuario.FindByCodUsuario(obj_Usuario);
                obj_Usuario.Sen_Usuario = obj_Usuario_Senha.Sen_Usuario;
            }
            else
            {
                //"LUIGIZERA" fica em LowerCase, por isso problemas no banco por fazer em UpperCase
                string CriptografaLower = obj_FuncGeral.Criptografa(tbox_Sen_Usuario.Text + "LUIGIZERA");
                obj_Usuario.Sen_Usuario = CriptografaLower.ToLower();
            }

            switch(cbox_Nvl_Usuario.Text)
            {
                case "Administrador":
                    {
                        obj_Usuario.Nvl_Usuario = 10;
                        break;
                    }
                case "Estagiário":
                    {
                        obj_Usuario.Nvl_Usuario = 0;
                        break;
                    }
                case "Funcionário":
                    {
                        obj_Usuario.Nvl_Usuario = 1;
                        break;
                    }
                case "Estoquista":
                    {
                        obj_Usuario.Nvl_Usuario = 2;
                        break;
                    }
                default:
                    {
        ...
        ***********************************************************************/
        private void PopulaTela(Usuario pobj_Usuario)
        {
            ...
            switch (pobj_Usuario.Nvl_Usuario)
            {
                case 10:
                    {
                        cbox_Nvl_Usuario.Text = "Administrador";
                        break;
                    }
                case 0:
                    {
                        cbox_Nvl_Usuario.Text = "Estagiário";
                        break;
                    }
                case 1:
                    {
                        cbox_Nvl_Usuario.Text = "Funcionário";
                        break;
                    }
                case 2:
                    {
                        cbox_Nvl_Usuario.Text = "Estoquista";
                        break;
                    }
                default:
                    {
