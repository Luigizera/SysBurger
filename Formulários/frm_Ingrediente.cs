    ...
    public partial class frm_Ingrediente : Form
    {
        ...
        ***********************************************************************/
        private Ingrediente PopulaObjeto()
        {
            ...
            obj_Ingrediente.Qnt_Ingrediente = Convert.ToInt16(tbox_Qnt_Ingrediente.Text);
        ...
        ***********************************************************************/
        private void PopulaTela(Ingrediente pobj_Ingrediente)
        {
            ...
            tbox_Qnt_Ingrediente.Text = pobj_Ingrediente.Qnt_Ingrediente.ToString();
        ...
        ***********************************************************************/
        ...
        private void tbox_Qnt_Ingrediente_KeyPress(object sender, KeyPressEventArgs e)
        {
